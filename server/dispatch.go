...
func GetMethodRegistry() map[string]HandlerFunc {
	return map[string]HandlerFunc{
		...
		"device.webview.attach":                 handleWebViewAttach,
		"device.webview.detach":                 handleWebViewDetach,
		...
		"device.webview.screenshot":             handleWebViewScreenshot,
		"device.webview.evaluate":               handleWebViewEvaluate,
		"device.webview.waitForLoadState":       handleWebViewWaitForLoadState,
		"device.webview.waitForUrl":             handleWebViewWaitForURL,
		"device.webview.query":                  handleWebViewQuery,
		"device.webview.element.click":          handleWebViewElementClick,
		"device.webview.element.fill":           handleWebViewElementFill,
		"device.webview.element.type":           handleWebViewElementType,
		"device.webview.element.press":          handleWebViewElementPress,
		"device.webview.element.hover":          handleWebViewElementHover,
		"device.webview.element.focus":          handleWebViewElementFocus,
		"device.webview.element.scrollIntoView": handleWebViewElementScrollIntoView,
		"device.webview.element.check":          handleWebViewElementCheck,
		"device.webview.element.selectOption":   handleWebViewElementSelectOption,
		"device.webview.element.inspect":        handleWebViewElementInspect,
		"device.webview.element.getAttribute":   handleWebViewElementGetAttribute,
		"device.webview.element.getProperty":    handleWebViewElementGetProperty,
		"device.webview.element.waitFor":        handleWebViewElementWaitFor,
